...
class Unite(models.Model):
    ...
    heure_debut_fixe = models.BooleanField(verbose_name="Heure de début fixe", default=False, help_text="Cochez cette case si vous souhaitez que l'utilisateur ne puisse pas modifier l'heure de début.")
    heure_fin = models.TimeField(verbose_name="Heure de fin", blank=True, null=True)
    heure_fin_fixe = models.BooleanField(verbose_name="Heure de fin fixe", default=False, help_text="Cochez cette case si vous souhaitez que l'utilisateur ne puisse pas modifier l'heure de fin.")
