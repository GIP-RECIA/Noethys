...
JOURS_COMPLETS_SEMAINE = [(0, "Lundi"), (1, "Mardi"), (2, "Mercredi"), (3, "Jeudi"), (4, "Vendredi"), (5, "Samedi"),
                          (6, "Dimanche")]
...
LISTE_VACANCES = [("Février", "Février"), ("Pâques", "Pâques"), ("Eté", "Eté"), ("Toussaint", "Toussaint"),
                  ("Noël", "Noël")]
...
LISTE_METHODES_TARIFS = [
    {"code": "montant_unique", "label": u"Montant unique", "type": "unitaire", "nbre_lignes_max": 1, "entete": None,
     "champs": ("montant_unique", "montant_questionnaire"), "champs_obligatoires": ("montant_unique",),
     "tarifs_compatibles": ("JOURN", "FORFAIT", "CREDIT")},
    {"code": "qf", "label": u"En fonction du quotient familial", "type": "unitaire", "nbre_lignes_max": None,
     "entete": "tranche", "champs": ("qf_min", "qf_max", "montant_unique"),
     "champs_obligatoires": ("qf_min", "qf_max", "montant_unique"),
     "tarifs_compatibles": ("JOURN", "FORFAIT", "CREDIT")},

    {"code": "horaire_montant_unique", "label": u"Montant unique en fonction d'une tranche horaire", "type": "horaire",
     "nbre_lignes_max": None, "entete": None, "champs": (
    "heure_debut_min", "heure_debut_max", "heure_fin_min", "heure_fin_max", "temps_facture", "montant_unique",
    "montant_questionnaire", "label"),
     "champs_obligatoires": ("heure_debut_min", "heure_debut_max", "heure_fin_min", "heure_fin_max", "montant_unique"),
     "tarifs_compatibles": ("JOURN",)},
    {"code": "horaire_qf", "label": u"En fonction d'une tranche horaire et du quotient familial", "type": "horaire",
     "nbre_lignes_max": None, "entete": None, "champs": (
    "qf_min", "qf_max", "heure_debut_min", "heure_debut_max", "heure_fin_min", "heure_fin_max", "temps_facture",
    "montant_unique", "label"), "champs_obligatoires": (
    "qf_min", "qf_max", "heure_debut_min", "heure_debut_max", "heure_fin_min", "heure_fin_max", "montant_unique"),
     "tarifs_compatibles": ("JOURN",)},

    {"code": "duree_montant_unique", "label": u"Montant unique en fonction d'une durée", "type": "horaire",
     "nbre_lignes_max": None, "entete": None,
     "champs": ("duree_min", "duree_max", "temps_facture", "montant_unique", "montant_questionnaire", "label"),
     "champs_obligatoires": ("duree_min", "duree_max", "montant_unique"), "tarifs_compatibles": ("JOURN",)},
    {"code": "duree_qf", "label": u"En fonction d'une durée et du quotient familial", "type": "horaire",
     "nbre_lignes_max": None, "entete": None,
     "champs": ("qf_min", "qf_max", "duree_min", "duree_max", "temps_facture", "montant_unique", "label"),
     "champs_obligatoires": ("qf_min", "qf_max", "duree_min", "duree_max", "montant_unique"),
     "tarifs_compatibles": ("JOURN",)},

    {"code": "montant_unique_date", "label": u"Montant unique en fonction de la date", "type": "unitaire",
     "nbre_lignes_max": None, "entete": None, "champs": ("date", "montant_unique", "label"),
     "champs_obligatoires": ("date", "montant_unique"), "tarifs_compatibles": ("JOURN",)},
    {"code": "qf_date", "label": u"En fonction de la date et du quotient familial", "type": "unitaire",
     "nbre_lignes_max": None, "entete": None, "champs": ("date", "qf_min", "qf_max", "montant_unique", "label"),
     "champs_obligatoires": ("date", "qf_min", "qf_max", "montant_unique"), "tarifs_compatibles": ("JOURN",)},
    ...
    {"code": "choix", "label": u"Tarif au choix (Sélectionné par l'utilisateur)", "type": "unitaire",
     "nbre_lignes_max": None, "entete": None, "champs": ("montant_unique", "label"),
     "champs_obligatoires": ("montant_unique",), "tarifs_compatibles": ("JOURN", "FORFAIT",)},

    {"code": "montant_evenement", "label": u"Montant de l'évènement", "type": "unitaire", "nbre_lignes_max": 0,
     "entete": None, "champs": (), "champs_obligatoires": (), "tarifs_compatibles": ("JOURN",)},

    {"code": "montant_unique_nbre_ind",
     "label": u"Montant unique en fonction du nombre d'individus de la famille présents", "type": "unitaire",
     "nbre_lignes_max": 1, "entete": "tranche", "champs": (
    "montant_enfant_1", "montant_enfant_2", "montant_enfant_3", "montant_enfant_4", "montant_enfant_5",
    "montant_enfant_6",), "champs_obligatoires": ("montant_enfant_1",), "tarifs_compatibles": ("JOURN",)},
    {"code": "qf_nbre_ind",
     "label": u"En fonction du quotient familial et du nombre d'individus de la famille présents", "type": "unitaire",
     "nbre_lignes_max": None, "entete": "tranche", "champs": (
    "qf_min", "qf_max", "montant_enfant_1", "montant_enfant_2", "montant_enfant_3", "montant_enfant_4",
    "montant_enfant_5", "montant_enfant_6",), "champs_obligatoires": ("qf_min", "qf_max", "montant_enfant_1"),
     "tarifs_compatibles": ("JOURN",)},
    {"code": "horaire_montant_unique_nbre_ind",
     "label": u"Montant unique en fonction du nombre d'individus de la famille présents et de la tranche horaire",
     "type": "unitaire", "nbre_lignes_max": None, "entete": "tranche", "champs": (
    "heure_debut_min", "heure_debut_max", "heure_fin_min", "heure_fin_max", "temps_facture", "montant_enfant_1",
    "montant_enfant_2", "montant_enfant_3", "montant_enfant_4", "montant_enfant_5", "montant_enfant_6", "label"),
     "champs_obligatoires": (
     "heure_debut_min", "heure_debut_max", "heure_fin_min", "heure_fin_max", "montant_enfant_1"),
     "tarifs_compatibles": ("JOURN",)},
    {"code": "montant_unique_nbre_ind_degr",
     "label": u"Montant dégressif en fonction du nombre d'individus de la famille présents", "type": "unitaire",
     "nbre_lignes_max": 1, "entete": "tranche", "champs": (
    "montant_enfant_1", "montant_enfant_2", "montant_enfant_3", "montant_enfant_4", "montant_enfant_5",
    "montant_enfant_6",), "champs_obligatoires": ("montant_enfant_1",), "tarifs_compatibles": ("JOURN",)},
    {"code": "qf_nbre_ind_degr",
     "label": u"Montant dégressif en fonction du quotient familial et du nombre d'individus de la famille présents",
     "type": "unitaire", "nbre_lignes_max": None, "entete": "tranche", "champs": (
    "qf_min", "qf_max", "montant_enfant_1", "montant_enfant_2", "montant_enfant_3", "montant_enfant_4",
    "montant_enfant_5", "montant_enfant_6",), "champs_obligatoires": ("qf_min", "qf_max", "montant_enfant_1"),
     "tarifs_compatibles": ("JOURN",)},
    {"code": "horaire_montant_unique_nbre_ind_degr",
     "label": u"Montant dégressif en fonction du nombre d'individus de la famille présents et de la tranche horaire",
     "type": "unitaire", "nbre_lignes_max": None, "entete": "tranche", "champs": (
    "heure_debut_min", "heure_debut_max", "heure_fin_min", "heure_fin_max", "temps_facture", "montant_enfant_1",
    "montant_enfant_2", "montant_enfant_3", "montant_enfant_4", "montant_enfant_5", "montant_enfant_6", "label"),
     "champs_obligatoires": (
    ...
    {"code": "duree_coeff_montant_unique", "label": u"Montant au prorata d'une durée", "type": "horaire",
     "nbre_lignes_max": None, "entete": None, "champs": (
    "duree_min", "duree_max", "duree_seuil", "duree_plafond", "duree_arrondi", "unite_horaire", "montant_unique",
    "montant_min", "montant_max", "montant_questionnaire", "ajustement", "label"),
     "champs_obligatoires": ("unite_horaire", "montant_unique"), "tarifs_compatibles": ("JOURN",)},
    {"code": "duree_coeff_qf", "label": u"Montant au prorata d'une durée et selon le quotient familial",
     "type": "horaire", "nbre_lignes_max": None, "entete": None, "champs": (
    "qf_min", "qf_max", "duree_min", "duree_max", "duree_seuil", "duree_plafond", "duree_arrondi", "unite_horaire",
    "montant_unique", "montant_min", "montant_max", "ajustement", "label"),
     "champs_obligatoires": ("qf_min", "qf_max", "unite_horaire", "montant_unique"), "tarifs_compatibles": ("JOURN",)},

    {"code": "taux_montant_unique", "label": u"Par taux d'effort", "type": "unitaire", "nbre_lignes_max": 1,
     "entete": None, "champs": ("taux", "montant_min", "montant_max", "ajustement", "label"),
     "champs_obligatoires": ("taux",), "tarifs_compatibles": ("JOURN",)},
    {"code": "taux_qf", "label": u"Par taux d'effort et par tranches de QF", "type": "unitaire",
     "nbre_lignes_max": None, "entete": None,
     "champs": ("qf_min", "qf_max", "taux", "montant_min", "montant_max", "ajustement", "label"),
     "champs_obligatoires": ("qf_min", "qf_max", "taux",), "tarifs_compatibles": ("JOURN",)},
    {"code": "taux_date", "label": u"Par taux d'effort et par date", "type": "unitaire", "nbre_lignes_max": None,
     "entete": None, "champs": ("date", "taux", "montant_min", "montant_max", "ajustement", "label"),
     "champs_obligatoires": ("date", "taux"), "tarifs_compatibles": ("JOURN",)},
    {"code": "duree_taux_montant_unique", "label": u"Par taux d'effort et en fonction d'une durée", "type": "horaire",
     "nbre_lignes_max": None, "entete": None,
     "champs": ("duree_min", "duree_max", "temps_facture", "taux", "montant_min", "montant_max", "ajustement", "label"),
     "champs_obligatoires": ("duree_min", "duree_max", "taux"), "tarifs_compatibles": ("JOURN",)},
    {"code": "duree_taux_qf", "label": u"Par taux d'effort et par tranches de QF en fonction d'une durée",
     "type": "horaire", "nbre_lignes_max": None, "entete": None, "champs": (
    "qf_min", "qf_max", "duree_min", "duree_max", "temps_facture", "taux", "montant_min", "montant_max", "ajustement",
    "label"), "champs_obligatoires": ("qf_min", "qf_max", "duree_min", "duree_max", "taux"),
     "tarifs_compatibles": ("JOURN",)},
...
DICT_COLONNES_TARIFS = {
    ...
    "montant_questionnaire": {"label": "Tarif questionnaire", "largeur": 130, "editeur": "questionnaire",
                              "infobulle": "Montant renseigné dans les questionnaires familiaux ou individuels"},
    ...
    "heure_debut_min": {"label": "Heure Début min >=", "largeur": 77, "editeur": "heure",
                        "infobulle": "Heure de début minimale"},
    "heure_debut_max": {"label": "Heure Début max <=", "largeur": 77, "editeur": "heure",
                        "infobulle": "Heure de début maximale"},
    "heure_fin_min": {"label": "Heure Fin min >=", "largeur": 75, "editeur": "heure",
                      "infobulle": "Heure de fin minimale"},
    "heure_fin_max": {"label": "Heure Fin max <=", "largeur": 75, "editeur": "heure",
                      "infobulle": "Heure de fin maximale"},
    ...
    "label": {"label": "Label de la prestation (Optionnel)", "largeur": 220, "editeur": None,
              "infobulle": "Label de la prestation. Variables disponibles :\n{QUANTITE}, {TEMPS_REALISE}, {TEMPS_FACTURE}, {HEURE_DEBUT}, {HEURE_FIN}."},
    "temps_facture": {"label": "Temps facturé (pour la CAF)", "largeur": 90, "editeur": "heure",
                      "infobulle": "Temps facturé"},
    "unite_horaire": {"label": "Unité horaire", "largeur": 70, "editeur": "heure",
                      "infobulle": "Unité horaire de base"},
    ...
    "ajustement": {"label": "Majoration/Déduction", "largeur": 75, "editeur": "decimal4",
                   "infobulle": "Montant à majorer ou à déduire sur le tarif"},
}
...
LISTE_CONTROLES_QUESTIONNAIRES = [
    ...
    {"code": "bloc_texte", "label": u"Bloc de texte multiligne", "image": "Texte_bloc.png", "options": {"hauteur": 60},
     "filtre": "texte"},
    {"code": "entier", "label": u"Nombre entier", "image": "Ctrl_nombre.png", "options": {"min": 0, "max": 99999},
     "filtre": "entier"},
    {"code": "decimal", "label": u"Nombre décimal", "image": "Ctrl_decimal.png", "options": {"min": 0, "max": 99999},
     "filtre": "decimal"},
    {"code": "montant", "label": u"Montant", "image": "Euro.png", "filtre": "montant"},
    {"code": "liste_deroulante", "label": u"Liste déroulante basique", "image": "Ctrl_choice.png",
     "options": {"choix": None}, "filtre": "choix"},
    {"code": "liste_deroulante_avancee", "label": u"Liste déroulante avancée", "image": "Ctrl_choice.png",
     "options": {"choix": None}, "filtre": "choix"},
    {"code": "liste_coches", "label": u"Sélection multiple", "image": "Coches.png",
     "options": {"hauteur": -1, "choix": None}, "filtre": "choix"},
    {"code": "case_coche", "label": u"Case à cocher", "image": "Ctrl_coche.png", "filtre": "coche"},
    {"code": "date", "label": u"Date", "image": "Jour.png", "filtre": "date"},
    {"code": "slider", "label": u"Réglette", "image": "Reglette.png", "options": {"hauteur": -1, "min": 0, "max": 100},
     "filtre": "entier"},
    ...
    {"code": "codebarres", "label": u"Code-barres", "image": "Codebarres.png", "options": {"norme": "39"},
     "filtre": "texte"},
...
CHOIX_AUTORISATIONS = [(None, "Autorisation non précisée"), (1, "Responsable légal(e)"),
                       (2, "Contacter en cas d'urgence"), (3, "Raccompagnement autorisé"),
                       (4, "Raccompagnement interdit")]
...
class AdresseMail(models.Model):
    ...
    adresse = models.EmailField(verbose_name="Adresse d'envoi", max_length=300,
                                help_text="Saisissez l'adresse mail utilisée.")
    motdepasse = encrypt(models.CharField(verbose_name="Mot de passe", max_length=300, blank=True, null=True,
                                          help_text="Saisissez le mot de passe de la messagerie."))
    hote = encrypt(models.CharField(verbose_name="Hôte", max_length=300, blank=True, null=True,
                                    help_text="Saisissez le nom de l'hôte de la messagerie (Ex: smtp.orange.fr, smtp.gmail.com...)."))
    port = models.IntegerField(verbose_name="Port", blank=True, null=True,
                               help_text="Saisissez le numéro de port (Ex: 995, 465...)")
    use_ssl = models.BooleanField(verbose_name="SSL", default=False,
                                  help_text="Cochez cette case si la messagerie exige le protocole SSL.")
    use_tls = models.BooleanField(verbose_name="TLS", default=False,
                                  help_text="Cochez cette case si la messagerie exige le protocole TLS.")
    utilisateur = encrypt(models.CharField(verbose_name="Utilisateur", max_length=300, blank=True, null=True,
                                           help_text="Saisissez le nom d'utilisateur (Souvent identique à l'adresse mail)."))
    nom_adresse = models.CharField(verbose_name="Adresse affichée", max_length=300, blank=True, null=True,
                                   help_text="Saisissez le nom ou l'adresse que vous souhaitez voir apparaître dans le client de messagerie du destinataire.")
    moteur = models.CharField(verbose_name="Moteur", max_length=200,
                              choices=[("smtp", "SMTP"), ("mailjet", "Mailjet"), ("brevo", "Brevo"),
                                       ("console", "Console")],
                              help_text="Sélectionnez un moteur d'expédition (Smtp ou Mailjet).")
    ...
    actif = models.BooleanField(verbose_name="Actif", default=True,
                                help_text="Décochez la case pour désactiver cette adresse.")
    lien_desinscription = models.BooleanField(verbose_name="Insérer un lien de désinscription dans les mails groupés",
                                              default=True,
                                              help_text="Un lien de désinscription sera inséré à la fin de chaque mail envoyé par lot.")
...
class ConfigurationSMS(models.Model):
    ...
    moteur = models.CharField(verbose_name="Moteur", max_length=200,
                              choices=[("mailjet", "Mailjet"), ("ovh", "OVH"), ("brevo", "Brevo")],
                              help_text="Sélectionnez un moteur d'expédition.")
    token = encrypt(models.CharField(verbose_name="Token", max_length=300, blank=True, null=True,
                                     help_text="Saisissez le token qui vous a été communiqué par votre fournisseur."))
    nom_exp = models.CharField(verbose_name="Nom de l'expéditeur", max_length=11, blank=True, null=True,
                               help_text="Saisissez le nom d'expéditeur qui doit apparaître dans le SMS (11 caractères max).")
    nbre_caracteres = models.IntegerField(verbose_name="Nbre caractères max.", default=160,
                                          help_text="Précisez le nombre de caractères maximal accepté pour un SMS (160 par défaut).")
    montant_unitaire = models.DecimalField(verbose_name="Montant unitaire", max_digits=10, decimal_places=4,
                                           default=0.0, help_text="Indiquez le coût unitaire d'un SMS.")
    solde = models.IntegerField(verbose_name="Solde de SMS", blank=True, null=True,
                                help_text="Précisez le nombre approximatif de SMS restants sur votre compte prépayé.")
    nom_compte = models.CharField(verbose_name="Nom du compte", max_length=200, blank=True, null=True,
                                  help_text="Saisissez le nom du compte.")
    identifiant = models.CharField(verbose_name="Identifiant", max_length=200, blank=True, null=True,
                                   help_text="Saisissez l'identifiant de l'utilisateur.")
    motdepasse = encrypt(models.CharField(verbose_name="Mot de passe", max_length=200, blank=True, null=True,
                                          help_text="Saisissez le mot de passe de l'utilisateur."))
...
class Structure(models.Model):
    ...
    adresse_exp = models.ForeignKey(AdresseMail, verbose_name="Adresse d'expédition", blank=True, null=True,
                                    on_delete=models.PROTECT,
                                    help_text="Sélectionnez une des adresses d'expédition d'emails dans la liste. Il est possible de créer de nouvelles adresses depuis le menu Paramétrage > Adresses d'expédition.")
    configuration_sms = models.ForeignKey(ConfigurationSMS, verbose_name="Configuration SMS", blank=True, null=True,
                                          on_delete=models.PROTECT,
                                          help_text="Sélectionnez une configuration SMS dans la liste. Il est possible de créer de nouvelles configurations depuis le menu Paramétrage > Configurations SMS.")
    messagerie_active = models.BooleanField(
        verbose_name="Les familles sont autorisées à converser avec cette structure depuis la rubrique Contact du portail.",
        default=True)
    afficher_coords = models.BooleanField(verbose_name="Afficher les coordonnées de la structure sur le portail.",
                                          default=True)
...
class SignatureEmail(models.Model):
    ...
    nom = models.CharField(verbose_name="Nom", max_length=250,
                           help_text="Donnez un nom à cette signature pour la retrouver plus facilement.")
    ...
    structure = models.ForeignKey(Structure, verbose_name="Structure", on_delete=models.PROTECT, blank=True, null=True,
                                  help_text="Associez si besoin cette signature à une structure pour limiter son accès aux utilisateurs.")
...
class Utilisateur(AbstractUser):
    ...
    structures = models.ManyToManyField(Structure, verbose_name="Structures", related_name="utilisateur_structures",
                                        blank=True)
    adresse_exp = models.ForeignKey(AdresseMail, verbose_name="Adresse d'expédition d'emails",
                                    related_name="utilisateur_adresse_exp", blank=True, null=True,
                                    on_delete=models.PROTECT,
                                    help_text="Sélectionnez une adresse d'expédition d'emails favorite dans la liste. Il est possible de créer de nouvelles adresses depuis le menu Paramétrage > Adresses d'expédition.")
    signature = models.ForeignKey(SignatureEmail, verbose_name="Signature d'emails",
                                  related_name="utilisateur_signature", blank=True, null=True, on_delete=models.PROTECT,
                                  help_text="Sélectionnez une signature d'emails favorite dans la liste. Il est possible de créer de nouvelles signatures depuis le menu Paramétrage > Signatures d'emails.")
...
class ModeReglement(models.Model):
    ...
    numero_piece = models.CharField(verbose_name="Numéro de pièce", max_length=100, choices=numero_choix, blank=True,
                                    null=True)
    nbre_chiffres = models.IntegerField(verbose_name="Nombre de caractères du numéro", blank=True, null=True)
    frais_choix = [(None, "Aucun"), ("LIBRE", "Montant libre"), ("FIXE", "Montant fixe"),
                   ("PRORATA", "Montant au prorata")]
    frais_gestion = models.CharField(verbose_name="Frais de gestion", max_length=100, choices=frais_choix, blank=True,
                                     null=True)
    frais_montant = models.DecimalField(verbose_name="Montant fixe des frais", max_digits=10, decimal_places=2,
                                        blank=True, null=True)
    frais_pourcentage = models.DecimalField(verbose_name="Prorata des frais", max_digits=10, decimal_places=2,
                                            blank=True, null=True)
    arrondi_choix = [("centimesup", "Arrondi au centime supérieur"), ("centimeinf", "Arrondi au centime inférieur")]
    frais_arrondi = models.CharField(verbose_name="Méthode d'arrondi", max_length=100, choices=arrondi_choix,
                                     default="centimesup", blank=True, null=True)
    ...
    type_comptable = models.CharField(verbose_name="Type comptable", max_length=100, choices=type_choix,
                                      default="banque", blank=True, null=True)
...
class TypeMaladie(models.Model):
    ...
    nom = models.CharField(verbose_name="Nom", max_length=200)
    vaccin_obligatoire = models.BooleanField(verbose_name="Vaccination obligatoire", default=False,
                                             help_text="Cochez cette case si la vaccination est obligatoire pour cette maladie.")
    vaccin_date_naiss_min = models.DateField(verbose_name="Date de naissance min.", blank=True, null=True,
                                             help_text="Si la vaccination n'est obligatoire que pour les individus nés à partir d'une date donnée, saisissez-là ici.")
...
class TypeCotisation(models.Model):
    ...
    activite = models.ForeignKey("Activite", verbose_name="Activité associée", on_delete=models.PROTECT, blank=True,
                                 null=True)
    structure = models.ForeignKey(Structure, verbose_name="Structure", on_delete=models.PROTECT, blank=True, null=True)
...
class UniteCotisation(models.Model):
    ...
    prefacturation = models.BooleanField(verbose_name="Activer la préfacturation pour cette unité", default=False,
                                         help_text="Cochez cette case pour que la famille puisse payer cette unité d'adhésion sur le portail même si aucune facture n'a été générée.")
...
class Produit(models.Model):
    ...
    montant = models.DecimalField(verbose_name="Montant", blank=True, null=True, max_digits=10, decimal_places=2,
                                  default=0.0)
...
class TarifProduit(models.Model):
    ...
    code_compta = models.CharField(verbose_name="Code comptable", max_length=200, blank=True, null=True)
    choix_methode = [("produit_montant_unique", "Montant unique"),
                     ("produit_proportionnel_quantite", "Montant proportionnel à la quantité")]
...
class FactureRegie(models.Model):
    ...
    compte_bancaire = models.ForeignKey(CompteBancaire, verbose_name="Compte bancaire associé",
...
class TypeConsentement(models.Model):
    ...
    nom = models.CharField(verbose_name="Nom", max_length=200,
                           help_text="Il s'agit généralement d'un nom du document. Exemple : Règlement intérieur de la structure...")
    structure = models.ForeignKey(Structure, verbose_name="Structure", on_delete=models.PROTECT, blank=True, null=True)
...
class UniteConsentement(models.Model):
    ...
    type_consentement = models.ForeignKey(TypeConsentement, verbose_name="type de consentement",
                                          on_delete=models.PROTECT)
    date_debut = models.DateField(verbose_name="Date de début",
                                  help_text="Saisissez la date de début d'application de cette unité. Par défaut la date du jour.")
    date_fin = models.DateField(verbose_name="Date de fin", blank=True, null=True,
                                help_text="La date de fin n'est généralement pas utilisée sauf si le document n'est applicable que sur une période donnée.")
    document = models.FileField(verbose_name="Document", upload_to=get_uuid_path, blank=True, null=True,
                                help_text="Privilégiez un document au format PDF.")
...
class Activite(models.Model):
    ...
    choix_affichage_inscriptions = [("JAMAIS", "Ne pas autoriser"), ("TOUJOURS", "Autoriser"),
                                    ("PERIODE", "Autoriser sur la période suivante")]
    portail_inscriptions_affichage = models.CharField(verbose_name="Inscriptions autorisées", max_length=100,
                                                      choices=choix_affichage_inscriptions, default="JAMAIS")
    portail_inscriptions_date_debut = models.DateTimeField(verbose_name="Date de début d'affichage", blank=True,
                                                           null=True)
    portail_inscriptions_date_fin = models.DateTimeField(verbose_name="Date de fin d'affichage", blank=True, null=True)
    portail_inscriptions_imposer_pieces = models.BooleanField(
        verbose_name="Imposer le téléchargement des pièces à fournir", default=False)
    portail_inscriptions_bloquer_si_complet = models.BooleanField(
        verbose_name="Empêcher l'inscription si activité complète", default=False)
    choix_affichage_reservations = [("JAMAIS", "Ne pas autoriser"), ("TOUJOURS", "Autoriser")]
    portail_reservations_affichage = models.CharField(verbose_name="Réservations autorisées", max_length=100,
                                                      choices=choix_affichage_reservations, default="JAMAIS")
    portail_reservations_limite = models.CharField(verbose_name="Date limite de modification d'une réservation",
    ...
    choix_affichage_dates_passees = [("0", "Jamais"), ("2", "Deux jours"), ("3", "Trois jours"), ("7", "Une semaine"),
                                     ("14", "Deux semaines"), ("30", "Un mois"), ("61", "Deux mois"),
                                     ("92", "Trois mois"), ("9999", "Toujours")]
    portail_afficher_dates_passees = models.CharField(verbose_name="Afficher les dates passées", max_length=100,
                                                      choices=choix_affichage_dates_passees, default="0")
    regie = models.ForeignKey(FactureRegie, verbose_name="Régie de facturation", on_delete=models.PROTECT, blank=True,
                              null=True)
    groupes_activites = models.ManyToManyField(TypeGroupeActivite, blank=True,
                                               related_name="activite_groupes_activites")
    pieces = models.ManyToManyField(TypePiece, verbose_name="Types de pièces", related_name="activite_types_pieces",
                                    blank=True,
                                    help_text="Sélectionnez dans la liste les types de pièces qui doivent être à jour.")
    cotisations = models.ManyToManyField(TypeCotisation, verbose_name="Types d'adhésions",
                                         related_name="activite_types_cotisations", blank=True,
                                         help_text="Sélectionnez dans la liste des types d'adhésions qui doivent être à jour.")
    types_consentements = models.ManyToManyField(TypeConsentement, verbose_name="Types de consentements",
                                                 related_name="activite_types_consentements", blank=True,
                                                 help_text="Sélectionnez dans la liste les types de consentements internet nécessaires.")
    inscriptions_multiples = models.BooleanField(
        verbose_name="Autoriser plusieurs inscriptions simultanées pour chaque individu", default=False)
    code_produit_local = models.CharField(verbose_name="Code produit local", max_length=200, blank=True, null=True)
    structure = models.ForeignKey(Structure, verbose_name="Structure", on_delete=models.PROTECT)
    service1 = models.CharField(verbose_name="Service axe 1", max_length=15, blank=True, null=True,
                                help_text="Premier axe analytique.")
    service2 = models.CharField(verbose_name="Service axe 2", max_length=10, blank=True, null=True,
                                help_text="Second axe analytique.")
    reattribution_auto = models.BooleanField(verbose_name="Réattribution automatique des places disponibles",
                                             default=False,
                                             help_text="Cochez cette case pour laisser Noethysweb réattribuer les places en attente automatiquement chaque nuit.")
    reattribution_adresse_exp = models.ForeignKey(AdresseMail, verbose_name="Adresse d'expédition", blank=True,
                                                  null=True, on_delete=models.PROTECT)
    reattribution_delai = models.IntegerField(verbose_name="Délai de réattribution", blank=True, null=True,
                                              choices=[(1, "1 jour"), (2, "2 jours"), (3, "3 jours"), (4, "4 jours"),
                                                       (5, "5 jours"), (7, "1 semaine"), (14, "2 semaines")], default=2,
                                              help_text="Sélectionnez le nombre de jours jusqu'auquel il est possible de réattribuer des places.")
    reattribution_modele_email = models.ForeignKey("ModeleEmail", verbose_name="Modèle d'Email", blank=True, null=True,
                                                   on_delete=models.PROTECT)
    validation_type = models.CharField(verbose_name="Type de validation", max_length=100,
                                       choices=[("AUTOMATIQUE", "Automatique"), ("MANUELLE", "Manuelle")],
                                       default="AUTOMATIQUE")
    validation_modele_email = models.ForeignKey("ModeleEmail", verbose_name="Modèle d'Email", blank=True, null=True,
                                                related_name="validation_modele_email", on_delete=models.PROTECT)
    ...
    def Get_validite_str(self):
        if not self.date_fin or self.date_fin.year == 2999:
            ...
            return "Du %s au %s" % (
            utils_dates.ConvertDateToFR(self.date_debut), utils_dates.ConvertDateToFR(self.date_fin))
...
class Unite(models.Model):
    ...
    nom = models.CharField(verbose_name="Nom", max_length=200)
    abrege = models.CharField(verbose_name="Abrégé", max_length=200)
    choix_type = [("Unitaire", "Unitaire"), ("Horaire", "Horaire"), ('Quantite', 'Quantité'),
                  ('Multihoraires', 'Multihoraires'), ('Evenement', 'Evénementiel')]
    ...
    heure_debut_fixe = models.BooleanField(verbose_name="Heure de début fixe", default=False,
                                           help_text="Cochez cette case si vous souhaitez que l'utilisateur ne puisse pas modifier l'heure de début.")
    ...
    heure_fin_fixe = models.BooleanField(verbose_name="Heure de fin fixe", default=False,
                                         help_text="Cochez cette case si vous souhaitez que l'utilisateur ne puisse pas modifier l'heure de fin.")
    ...
    restaurateur = models.ForeignKey(Restaurateur, verbose_name="Restaurateur", blank=True, null=True,
    ...
    choix_touches = [("WXK_TAB", "Tabulation"), ("WXK_SHIFT", "Shift"), ('WXK_ALT', 'Alt'), ('WXK_CONTROL', 'Control'),
                     ('WXK_SPACE', 'Barre espace'),
                     ("WXK_F1", "F1"), ("WXK_F2", "F2"), ('WXK_F3', 'F3'), ('WXK_F4', 'F4'), ('WXK_F5', 'F5'),
                     ('WXK_F6', 'F6'), ('WXK_F7', 'F7'),
                     ("WXK_F8", "F8"), ("WXK_F9", "F9"), ('WXK_F10', 'F10'), ('WXK_F11', 'F11'), ('WXK_F12', 'F12')]
    touche_raccourci = models.CharField(verbose_name="Touche raccourci", max_length=50, choices=choix_touches,
                                        blank=True, null=True)
    ...
    autogen_conditions = models.CharField(verbose_name="Conditions de la génération", max_length=400, blank=True,
                                          null=True)
    autogen_parametres = models.CharField(verbose_name="Paramètres de la génération", max_length=400, blank=True,
                                          null=True)
    ...
    imposer_saisie_valeur = models.BooleanField(
        verbose_name="Imposer la saisie de la valeur aux usagers sur le portail", default=False)
...
class UniteRemplissage(models.Model):
    ...
    ordre = models.IntegerField(verbose_name="Ordre")
    nom = models.CharField(verbose_name="Nom", max_length=200,
                           help_text="Renseigner le nom complet de l'unité. Exemples : Journée, Matinée, Séance, Atelier...")
    abrege = models.CharField(verbose_name="Abrégé", max_length=200,
                              help_text="Le nom abrégé est généralement constitué de quelques caractères en majuscules. Exemples : J, M, SEANCE, ATELIER...")
    date_debut = models.DateField(verbose_name="Date de début de validité", blank=True, null=True)
    date_fin = models.DateField(verbose_name="Date de fin de validité", blank=True, null=True)
    seuil_alerte = models.IntegerField(verbose_name="Seuil d'alerte", default=5,
                                       help_text="Nombre de places restantes à partir duquel il faut colorer le fond de la case en jaune. Valeur conseillée : 5.")
    ...
    afficher_page_accueil = models.BooleanField(verbose_name="Afficher dans les effectifs de la page d'accueil",
                                                default=True)
...
class CategorieEvenement(models.Model):
    ...
    nom = models.CharField(verbose_name="Nom", max_length=200)
    image = models.ImageField(verbose_name="Image", upload_to=get_uuid_path, blank=True, null=True)
    choix_limitations = [(None, "Aucune"), ("1EVTJOUR", "1 événement par jour max"),
                         ("2EVTJOUR", "2 événements par jour max"), ("3EVTJOUR", "3 événements par jour max"),
                         ("1EVTSEMAINE", "1 événement par semaine max"),
                         ("2EVTSEMAINE", "2 événements par semaine max"),
                         ("3EVTSEMAINE", "3 événements par semaine max"),
                         ("4EVTSEMAINE", "4 événements par semaine max")]
    limitations = models.CharField(verbose_name="Limitation", max_length=100, choices=choix_limitations, default=None,
                                   blank=True, null=True)
...
class Evenement(models.Model):
    ...
    visible_portail = models.BooleanField(verbose_name="Visible sur le portail", default=True)
    image = models.ImageField(verbose_name="Image", upload_to=get_uuid_path, blank=True, null=True)
    categorie = models.ForeignKey(CategorieEvenement, verbose_name="Catégorie", blank=True, null=True,
                                  on_delete=models.PROTECT)
...
class Tarif(models.Model):
    idtarif = models.AutoField(verbose_name="ID", db_column='IDtarif', primary_key=True)
    activite = models.ForeignKey(Activite, verbose_name="Activité", on_delete=models.CASCADE)
    choix_type = [("JOURN", "Prestation journalière"), ("FORFAIT", "Forfait daté"), ("CREDIT", "Forfait crédit"),
                  ("BAREME", "Barême de contrat"), ("EVENEMENT", "Evénement")]
    type = models.CharField(verbose_name="Type", max_length=100, choices=choix_type, default="JOURN")
    nom_tarif = models.ForeignKey(NomTarif, verbose_name="Nom de tarif", blank=True, null=True,
                                  on_delete=models.CASCADE)
    date_debut = models.DateField(verbose_name="Date de début")
    date_fin = models.DateField(verbose_name="Date de fin", blank=True, null=True)
    ...
    forfait_saisie_manuelle = models.BooleanField(
        verbose_name="Ce forfait peut être saisi manuellement depuis la grille des consommations", default=False)
    forfait_saisie_auto = models.BooleanField(
        verbose_name="Ce forfait est automatiquement créé lors de l'inscription à l'activité", default=False)
    forfait_suppression_auto = models.BooleanField(
        verbose_name="Ce forfait ne peut être supprimé que lors de la désinscription à l'activité", default=False)
    ...
    forfait_beneficiaire = models.CharField(verbose_name="Bénéficiaire", max_length=50, choices=beneficiaire_choix,
                                            default="individu", blank=True, null=True)
    description = models.CharField(verbose_name="Description", max_length=400, blank=True, null=True)
    jours_scolaires = MultiSelectField(verbose_name="Jours sur les périodes scolaires", max_length=100,
                                       choices=JOURS_SEMAINE, blank=True, null=True)
    jours_vacances = MultiSelectField(verbose_name="Jours sur les périodes de vacances", max_length=100,
                                      choices=JOURS_SEMAINE, blank=True, null=True)
    ...
    # etiquettes = models.CharField(blank=True, null=True)
    etats = MultiSelectField(verbose_name="Etats conditionnels", max_length=200, choices=LISTE_ETATS_CONSO, blank=True,
                             null=True)
    label_prestation = models.CharField(verbose_name="Label de la prestation", max_length=300, blank=True, null=True)
    ...
    categories_tarifs = models.ManyToManyField(CategorieTarif, verbose_name="Catégories de tarifs",
                                               related_name="tarif_categories_tarifs")
    ...
    cotisations = models.ManyToManyField(TypeCotisation, verbose_name="Cotisations", blank=True,
                                         related_name="tarif_cotisations")
    caisses = models.ManyToManyField(Caisse, verbose_name="Caisses", blank=True, related_name="tarif_caisses")
    type_quotient = models.ForeignKey(TypeQuotient, verbose_name="Type de QF", blank=True, null=True,
                                      on_delete=models.CASCADE,
                                      help_text="Sélectionnez un type de quotient familial ou laissez le champ vide pour tenir compte de tous les types de quotients.")
    facturation_unite = models.BooleanField(verbose_name="Facturation par unité horaire", default=False,
                                            help_text="Le montant par unité horaire et la quantité seront mémorisés dans la prestation.")
    choix_penalite = [(None, "Aucune"), ("pourcentage", "Pourcentage du montant dû")]
    penalite = models.CharField(verbose_name="Pénalité", max_length=100, choices=choix_penalite, default=None,
                                blank=True, null=True,
                                help_text="Sélectionnez un type de pénalité financière à appliquer en cas d'absence injustifiée.")
    penalite_pourcentage = models.DecimalField(verbose_name="Pourcentage", max_digits=10, decimal_places=2, default=100,
                                               blank=True, null=True, help_text="Saisissez le pourcentage à appliquer.")
    penalite_label = models.CharField(verbose_name="Label de la prestation", max_length=300, blank=True, null=True,
                                      help_text="Saisissez le label de la prestation de pénalité. Laissez vide pour utiliser le label par défaut. Mots-clés disponibles : {LABEL_PRESTATION}.")
    ...
    def __str__(self):
        return "Tarif ID%d - %s - à partir du %s" % (self.idtarif, self.nom_tarif.nom if self.nom_tarif else "",
                                                     self.date_debut.strftime(
                                                         "%d/%m/%Y")) if self.idtarif else "Nouveau tarif"
...
class ModelePrestation(models.Model):
    ...
    categorie_tarif = models.ForeignKey(CategorieTarif, verbose_name="Catégorie de tarif", on_delete=models.SET_NULL,
                                        blank=True, null=True)
    tva = models.DecimalField(verbose_name="Taux de TVA", max_digits=10, decimal_places=2, default=0.0, blank=True,
                              null=True)
    code_compta = models.CharField(verbose_name="Code comptable", max_length=200, blank=True, null=True)
    public_choix = [("individu", "Individu"), ("famille", "Famille")]
    public = models.CharField(verbose_name="Public", max_length=50, choices=public_choix)
...
class TarifLigne(models.Model):
    ...
    choix_methode = [(dict_methode["code"], dict_methode["label"]) for dict_methode in LISTE_METHODES_TARIFS]
    code = models.CharField(verbose_name="Méthode", max_length=200, choices=choix_methode, default="montant_unique",
                            blank=True, null=True)
    ...
    qf_min = models.DecimalField(verbose_name="QF min", max_digits=10, decimal_places=2, default=0.0, blank=True,
                                 null=True)
    qf_max = models.DecimalField(verbose_name="QF max", max_digits=10, decimal_places=2, default=0.0, blank=True,
                                 null=True)
    montant_unique = models.DecimalField(verbose_name="Montant unique", max_digits=10, decimal_places=3, default=0.0,
                                         blank=True, null=True)
    montant_enfant_1 = models.DecimalField(verbose_name="Montant enfant 1", max_digits=10, decimal_places=2,
                                           default=0.0, blank=True, null=True)
    montant_enfant_2 = models.DecimalField(verbose_name="Montant enfant 2", max_digits=10, decimal_places=2,
                                           default=0.0, blank=True, null=True)
    montant_enfant_3 = models.DecimalField(verbose_name="Montant enfant 3", max_digits=10, decimal_places=2,
                                           default=0.0, blank=True, null=True)
    montant_enfant_4 = models.DecimalField(verbose_name="Montant enfant 4", max_digits=10, decimal_places=2,
                                           default=0.0, blank=True, null=True)
    montant_enfant_5 = models.DecimalField(verbose_name="Montant enfant 5", max_digits=10, decimal_places=2,
                                           default=0.0, blank=True, null=True)
    montant_enfant_6 = models.DecimalField(verbose_name="Montant enfant 6", max_digits=10, decimal_places=2,
                                           default=0.0, blank=True, null=True)
    nbre_enfants = models.IntegerField(verbose_name="Nombre d'enfants pour le calcul par taux d'effort", blank=True,
                                       null=True)
    coefficient = models.DecimalField(verbose_name="Coefficient", max_digits=10, decimal_places=2, default=0.0,
                                      blank=True, null=True)
    montant_min = models.DecimalField(verbose_name="Montant min", max_digits=10, decimal_places=2, default=0.0,
                                      blank=True, null=True)
    montant_max = models.DecimalField(verbose_name="Montant max", max_digits=10, decimal_places=2, default=0.0,
                                      blank=True, null=True)
    ...
    taux = models.DecimalField(verbose_name="Taux d'effort", max_digits=10, decimal_places=6, default=0.0, blank=True,
                               null=True)
    ajustement = models.DecimalField(verbose_name="Ajustement", max_digits=10, decimal_places=4, default=0.0,
                                     blank=True, null=True)
    montant_questionnaire = models.CharField(verbose_name="Montant questionnaire", max_length=100, blank=True,
                                             null=True)
    revenu_min = models.DecimalField(verbose_name="Montant revenu min", max_digits=10, decimal_places=2, default=0.0,
                                     blank=True, null=True)
    revenu_max = models.DecimalField(verbose_name="Montant revenu max", max_digits=10, decimal_places=2, default=0.0,
                                     blank=True, null=True)
...
class Remplissage(models.Model):
    ...
    activite = models.ForeignKey(Activite, verbose_name="Activité", on_delete=models.CASCADE)
    unite_remplissage = models.ForeignKey(UniteRemplissage, verbose_name="Unité de remplissage",
                                          on_delete=models.CASCADE)
    groupe = models.ForeignKey(Groupe, verbose_name="Groupe", on_delete=models.CASCADE, blank=True, null=True)
    date = models.DateField(verbose_name="Date")
...
class Individu(models.Model):
    ...
    civilite = models.IntegerField(verbose_name=_("Civilité"), db_column='IDcivilite',
                                   choices=data_civilites.GetListeCivilitesForModels(), default=1)
    nom = models.CharField(verbose_name=_("Nom"), max_length=200)
    ...
    idpays_naiss = models.IntegerField(verbose_name=_("Pays de naissance"), db_column='IDpays_naiss', blank=True,
                                       null=True)
    ...
    categorie_travail = models.ForeignKey(CategorieTravail, verbose_name=_("Catégorie socio-professionnelle"),
                                          on_delete=models.PROTECT, blank=True, null=True)
    ...
    memo = models.TextField(verbose_name=_("Mémo"), blank=True, null=True)
    type_sieste = models.ForeignKey(TypeSieste, verbose_name=_("Sieste"), on_delete=models.PROTECT, blank=True,
                                    null=True)
    date_creation = models.DateTimeField(verbose_name="Date de création", auto_now_add=True)
    travail_tel_sms = models.BooleanField(verbose_name="Autoriser l'envoi de SMS vers le téléphone pro.", default=False)
    tel_domicile_sms = models.BooleanField(verbose_name="Autoriser l'envoi de SMS vers le téléphone du domicile",
                                           default=False)
    tel_mobile_sms = models.BooleanField(verbose_name="Autoriser l'envoi de SMS vers le téléphone portable",
                                         default=False)
    ...
    regimes_alimentaires = models.ManyToManyField(RegimeAlimentaire, verbose_name=_("Régimes alimentaires"),
                                                  related_name="individu_regimes_alimentaires", blank=True)
    maladies = models.ManyToManyField(TypeMaladie, verbose_name=_("Maladies contractées"),
                                      related_name="individu_maladies", blank=True)
    situation_familiale_choix = [(1, "Célibataires"), (2, "Mariés"), (3, "Divorcés"), (4, "Veuf(ve)"),
                                 (5, "En concubinage"), (6, "Séparés"), (7, "Pacsés"), (8, "En union libre"),
                                 (9, "Autre")]
    situation_familiale = models.IntegerField(verbose_name=_("Situation des parents"),
                                              choices=situation_familiale_choix, blank=True, null=True)
    ...
    # new attributs
    internet_categorie = models.ForeignKey(CategorieCompteInternet, verbose_name="Catégorie",
                                           related_name="internet_categori", on_delete=models.PROTECT, blank=True,
                                           null=True)
    ...
    blocage_impayes_off = models.BooleanField(verbose_name="Ne jamais appliquer le blocage des réservations si impayés",
                                              default=False,
                                              help_text="En cochant cette case, vous permettez à cette famille d'accéder aux réservations du portail même s'il y a des impayés et que le paramètre 'blocage si impayés' a été activé dans les paramètres généraux du portail.")
    ...
    def Get_age(self, today=None):
        if self.date_naiss:
            ...
            return today.year - self.date_naiss.year - (
                        (today.month, today.day) < (self.date_naiss.month, self.date_naiss.day))
        else:
            return None
...
class Scolarite(models.Model):
    ...
    def __str__(self):
        return "Etape de scolarité du %s au %s" % (
...
class Famille(models.Model):
    ...
    num_allocataire = encrypt(
        models.CharField(verbose_name="Numéro d'allocataire", max_length=100, blank=True, null=True))
    ...
    internet_secquest = models.CharField(verbose_name="Question", max_length=200, blank=True, null=True)
    internet_categorie = models.ForeignKey(CategorieCompteInternet, verbose_name="Catégorie",
                                           related_name="internet_categorie", on_delete=models.PROTECT, blank=True,
                                           null=True)
    internet_reservations = models.BooleanField(verbose_name="Autoriser les réservations sur le portail", default=True)
    memo = models.TextField(verbose_name="Mémo", blank=True, null=True)
    utilisateur = models.OneToOneField(Utilisateur, on_delete=models.CASCADE, null=True)
    ...
    email_factures = models.BooleanField(verbose_name="Activation de l'envoi des factures par Email", default=False)
    email_factures_adresses = models.CharField(verbose_name="Adresses pour l'envoi des factures par Email",
                                               max_length=400, blank=True, null=True)
    email_recus = models.BooleanField(verbose_name="Activation de l'envoi des reçus par Email", default=False)
    email_recus_adresses = models.CharField(verbose_name="Adresses pour l'envoi des reçus par Email", max_length=400,
                                            blank=True, null=True)
    email_depots = models.BooleanField(verbose_name="Activation de l'envoi des avis d'encaissement par Email",
                                       default=False)
    email_depots_adresses = models.CharField(verbose_name="Adresses pour l'envoi des avis d'encaissement par Email",
                                             max_length=400, blank=True, null=True)
    code_compta = models.CharField(verbose_name="Code comptable", max_length=200, blank=True, null=True)
    titulaire_helios = models.ForeignKey(Individu, verbose_name="Titulaire Hélios", related_name="titulaire_helios",
                                         on_delete=models.SET_NULL, blank=True, null=True)
    tiers_solidaire = models.ForeignKey(Individu, verbose_name="Tiers solidaire", related_name="tiers_solidaire",
                                        on_delete=models.SET_NULL, blank=True, null=True)
    idtiers_helios = models.CharField(verbose_name="Identifiant national", max_length=300, blank=True, null=True,
                                      help_text="Saisissez l'identifiant national (SIRET ou SIREN ou FINESS ou NIR)")
    natidtiers_helios = models.IntegerField(verbose_name="Type d'identifiant national", blank=True, null=True,
                                            choices=LISTE_TYPES_ID_TIERS, default=9999,
                                            help_text="Sélectionnez le type d'identifiant national du tiers pour Hélios (Trésor Public)")
    reftiers_helios = models.CharField(verbose_name="Référence locale", max_length=200, blank=True, null=True,
                                       help_text="Saisissez la référence locale du tiers")
    cattiers_helios = models.IntegerField(verbose_name="Catégorie de tiers", blank=True, null=True,
                                          choices=LISTE_CATEGORIES_TIERS, default=1,
                                          help_text="Sélectionnez la catégorie de tiers pour Hélios (Trésor Public)")
    natjur_helios = models.IntegerField(verbose_name="Nature juridique", blank=True, null=True,
                                        choices=LISTE_NATURES_JURIDIQUES, default=1,
                                        help_text="Sélectionnez la nature juridique du tiers pour Hélios (Trésor Public)")
    ...
    mail = encrypt(models.EmailField(verbose_name="Email favori", max_length=300, blank=True, null=True))
    # mail = models.ForeignKey(AdresseMail, verbose_name="Email favori", blank=True, null=True, on_delete=models.SET_NULL)
    mobile = encrypt(models.CharField(verbose_name="Portable favori", max_length=100, blank=True, null=True))
    utilisateur = models.OneToOneField(Utilisateur, on_delete=models.CASCADE, null=True)
    certification_date = models.DateTimeField(verbose_name="Date de certification", blank=True, null=True)
    facturation_nom = models.CharField(verbose_name="Nom", max_length=300, blank=True, null=True)
    ...
    facturation_cp_resid = encrypt(models.CharField(verbose_name="Code postal", max_length=50, blank=True, null=True))
    facturation_ville_resid = encrypt(models.CharField(verbose_name="Ville", max_length=200, blank=True, null=True))
    email_blocage = models.BooleanField(verbose_name="La famille ne souhaite pas recevoir de mails groupés",
                                        default=False,
                                        help_text="L'éditeur d'emails groupés du menu Outils ne proposera pas cette famille dans les destinataires.")
    mobile_blocage = models.BooleanField(verbose_name="La famille ne souhaite pas recevoir de SMS groupés",
                                         default=False,
                                         help_text="L'éditeur de SMS groupés du menu Outils ne proposera pas cette famille dans les destinataires.")
    individus_masques = models.ManyToManyField(Individu, verbose_name="Individus masqués",
                                               related_name="individus_masques", blank=True)
    blocage_impayes_off = models.BooleanField(verbose_name="Ne jamais appliquer le blocage des réservations si impayés",
                                              default=False,
                                              help_text="En cochant cette case, vous permettez à cette famille d'accéder aux réservations du portail même s'il y a des impayés et que le paramètre 'blocage si impayés' a été activé dans les paramètres généraux du portail.")
    contact_facturation = models.ForeignKey(Individu, verbose_name="Contact facturation",
                                            related_name="contact_facturation", on_delete=models.SET_NULL, blank=True,
                                            null=True)
    ...
    # @property
    # def email(self):
    #     return self.mail.adresse if self.mail else None
    def __str__(self):
        return self.nom if self.nom else "Famille ID%s" % self.pk

    def Maj_infos(self, maj_adresse=True, maj_mail=True, maj_mobile=True, maj_titulaire_helios=True,
                  maj_tiers_solidaire=True, maj_code_compta=True):
        ...
        rattachements = Rattachement.objects.prefetch_related('individu').filter(famille=self, categorie=1,
                                                                                 titulaire=True).order_by("pk")
        ...
        if maj_code_compta:
            if not self.code_compta and rattachements:
                ...
                prenom = utils_texte.Supprimer_accents(
                    titulaire.individu.prenom.upper()) if titulaire.individu.prenom else ""
...
class Inscription(models.Model):
    ...
    date_debut = models.DateField(verbose_name="Date de début")
    date_fin = models.DateField(verbose_name="Date de fin", blank=True, null=True)
    statut_choix = [("ok", "Inscription validée"), ("attente", "Inscription en attente"),
...
class Information(models.Model):
    ...
    diffusion_listing_enfants = models.BooleanField(verbose_name="Afficher sur la liste des informations personnelles",
                                                    default=False)
    ...
    document = models.FileField(verbose_name=_("Document"), storage=get_storage("probleme"), upload_to=get_uuid_path,
                                blank=True, null=True, help_text="Vous pouvez ajouter un document.")
...
class Note(models.Model):
    ...
    categorie = models.ForeignKey(NoteCategorie, verbose_name="Catégorie", on_delete=models.PROTECT, blank=True,
                                  null=True, help_text="Vous pouvez sélectionner une catégorie de note (optionnel).")
    ...
    date_parution = models.DateField(verbose_name="Date de parution",
                                     help_text="Cette option permet de différer la parution de la note. Par défaut la date du jour.")
    ...
    collaborateur = models.ForeignKey("Collaborateur", verbose_name="Collaborateur", blank=True, null=True,
                                      on_delete=models.CASCADE)
    ...
    utilisateur = models.ForeignKey(Utilisateur, verbose_name="Utilisateur", blank=True, null=True,
                                    on_delete=models.CASCADE)
...
class Piece(models.Model):
    ...
    type_piece = models.ForeignKey(TypePiece, verbose_name="Type de pièce", on_delete=models.PROTECT, blank=True,
                                   null=True)
    individu = models.ForeignKey(Individu, verbose_name="Individu", on_delete=models.CASCADE, blank=True, null=True)
    famille = models.ForeignKey(Famille, verbose_name="Famille", on_delete=models.CASCADE, blank=True, null=True)
    date_debut = models.DateField(verbose_name="Date de début", blank=True, null=True)
    date_fin = models.DateField(verbose_name="Date de fin", blank=True, null=True)
    document = models.FileField(verbose_name="Document", storage=get_storage("piece"), upload_to=get_uuid_path,
                                blank=True, null=True)
...
class Facture(models.Model):
    ...
    lot = models.ForeignKey(LotFactures, verbose_name="Lot de factures", on_delete=models.PROTECT, blank=True,
                            null=True)
    ...
    def Maj_solde_actuel(self):
        if self.etat == "annulation":
            return
        montant_regle = Ventilation.objects.filter(prestation__facture=self.idfacture).aggregate(Sum('montant'))[
            "montant__sum"]
...
class Prestation(models.Model):
    ...
    date = models.DateField(verbose_name="Date")
    categorie_choix = [("cotisation", "Adhésion"), ("consommation", "Consommation"), ("location", "Location"),
                       ("autre", "Autre")]
    categorie = models.CharField(verbose_name="Catégorie", max_length=100, choices=categorie_choix, default="autre")
    label = models.CharField(verbose_name="Label", max_length=200)
    ...
    code_produit_local = models.CharField(verbose_name="Code produit local", max_length=200, blank=True, null=True)
    tarif_ligne = models.ForeignKey(TarifLigne, verbose_name="Ligne de tarif", on_delete=models.SET_NULL, blank=True,
                                    null=True)
...
class Consommation(models.Model):
    ...
    inscription = models.ForeignKey(Inscription, verbose_name="Inscription", blank=True, null=True,
                                    on_delete=models.PROTECT)
    activite = models.ForeignKey(Activite, verbose_name="Activité", blank=True, null=True, on_delete=models.PROTECT)
    date = models.DateField(verbose_name="Date", blank=True, null=True)
    unite = models.ForeignKey(Unite, verbose_name="Unité de consommation", blank=True, null=True,
                              on_delete=models.PROTECT)
    ...
    categorie_tarif = models.ForeignKey(CategorieTarif, verbose_name="Catégorie de tarif", on_delete=models.PROTECT,
                                        blank=True, null=True)
    # idcompte_payeur = models.IntegerField(db_column='IDcompte_payeur', blank=True, null=True)  # Field name made lowercase.
    prestation = models.ForeignKey(Prestation, verbose_name="Prestation", on_delete=models.PROTECT, blank=True,
                                   null=True)
    forfait = models.IntegerField(verbose_name="Type de forfait", blank=True, null=True)
...
class Cotisation(models.Model):
    ...
    depot_cotisation = models.ForeignKey(DepotCotisations, verbose_name="Dépôt d'adhésions", on_delete=models.PROTECT,
                                         blank=True, null=True)
    date_debut = models.DateField(verbose_name="Date de début")
    date_fin = models.DateField(verbose_name="Date de fin")
    prestation = models.OneToOneField(Prestation, verbose_name="Prestation", on_delete=models.SET_NULL, blank=True,
                                      null=True)
    observations = models.TextField(verbose_name="Observations", blank=True, null=True)
...
class Aide(models.Model):
    ...
    date_fin = models.DateField(verbose_name="Date de fin")
    caisse = models.ForeignKey(Caisse, verbose_name="Caisse", blank=True, null=True, on_delete=models.PROTECT)
    montant_max = models.DecimalField(verbose_name="Montant plafond", max_digits=10, decimal_places=2, default=0.0,
                                      blank=True, null=True)
...
class Quotient(models.Model):
    ...
    date_fin = models.DateField(verbose_name="Date de fin")
    quotient = encrypt(
        models.DecimalField(verbose_name="Quotient", max_digits=10, decimal_places=2, default=0.0, blank=True,
                            null=True))
    revenu = encrypt(
        models.DecimalField(verbose_name="Revenu", max_digits=10, decimal_places=2, default=0.0, blank=True, null=True))
    ...
    document = models.FileField(verbose_name="Document", storage=get_storage("quotient"), upload_to=get_uuid_path,
                                blank=True, null=True)
...
class QuestionnaireQuestion(models.Model):
    ...
    controle = models.CharField(verbose_name="contrôle", max_length=200,
                                choices=[(ctrl["code"], ctrl["label"]) for ctrl in LISTE_CONTROLES_QUESTIONNAIRES])
    choix = models.CharField(verbose_name="Choix", max_length=500, blank=True, null=True,
                             help_text="Saisissez les choix possibles séparés par un point-virgule. Exemple : 'Bananes;Pommes;Poires'")
    ...
    visible_fiche_renseignement = models.BooleanField(verbose_name="Visible sur les fiches de renseignements",
                                                      default=False)
    texte_aide = models.CharField(verbose_name="Texte d'aide", max_length=500, blank=True, null=True,
                                  help_text="Vous pouvez saisir un texte d'aide qui apparaîtra sous le champ de saisie.")
    structure = models.ForeignKey(Structure, verbose_name="Structure", on_delete=models.PROTECT, blank=True, null=True)
        ...
        if self.question.controle == "liste_deroulante_avancee":
            if self.reponse and dict_choix.get(int(self.reponse), None):
                ...
                if icone and couleur:
                    return "<i class='fa fa-%s margin-r-5' style='color: %s'></i> %s</span>" % (
                    icone, couleur, choix.label)
                return choix.label
...
class Depot(models.Model):
    ...
    observations = models.TextField(verbose_name="Observations", blank=True, null=True)
    code_compta = models.CharField(verbose_name="Code comptable", max_length=200, blank=True, null=True)
    montant = models.DecimalField(verbose_name="Montant", max_digits=10, decimal_places=2, default=0.0, blank=True,
                                  null=True)
...
class Attestation(models.Model):
    ...
    exclusions_prestations = models.CharField(verbose_name="Exclusion prestations", max_length=300, blank=True,
                                              null=True)
    date_debut = models.DateField(verbose_name="Date de début")
    date_fin = models.DateField(verbose_name="Date de fin")
    total = models.DecimalField(verbose_name="Total", max_digits=10, decimal_places=2, default=0.0)
...
class Historique(models.Model):
    ...
    activite = models.ForeignKey(Activite, verbose_name="Activité associée", on_delete=models.SET_NULL, blank=True,
                                 null=True)
...
class Lien(models.Model):
    ...
    famille = models.ForeignKey(Famille, verbose_name="Famille", on_delete=models.CASCADE, blank=True, null=True)
    individu_sujet = models.ForeignKey(Individu, verbose_name="Individu sujet", related_name="individu_sujet",
                                       blank=True, null=True, on_delete=models.CASCADE)
    idtype_lien = models.IntegerField(verbose_name="Type de lien", blank=True, null=True)
    individu_objet = models.ForeignKey(Individu, verbose_name="Individu objet", related_name="individu_objet",
                                       blank=True, null=True, on_delete=models.CASCADE)
    responsable = models.BooleanField(verbose_name="Responsable", default=False)
    autorisation = models.IntegerField(verbose_name="Type d'autorisation", blank=True, null=True,
                                       choices=CHOIX_AUTORISATIONS)
...
class Destinataire(models.Model):
    ...
    liste_diffusion = models.ForeignKey(ListeDiffusion, verbose_name="Liste de diffusion", blank=True, null=True,
                                        on_delete=models.CASCADE)
...
class Mail(models.Model):
    ...
    utilisateur = models.ForeignKey(Utilisateur, verbose_name="Utilisateur", blank=True, null=True,
                                    on_delete=models.CASCADE)
    adresse_exp = models.ForeignKey(AdresseMail, verbose_name="Expéditeur", blank=True, null=True,
    ...
    def __str__(self):
        return "Email du %s : %s" % (self.date_creation.strftime('%d/%m/%Y %H:%m') if self.date_creation else "X",
                                     self.objet if self.objet else "Sans objet")
...
class PortailPeriode(models.Model):
    ...
    date_debut = models.DateField(verbose_name="Date de début")
    date_fin = models.DateField(verbose_name="Date de fin")
    choix_type_date = [("TOUTES", "Toutes les dates"), ("VACANCES", "Uniquement les dates de vacances"),
                       ("SCOLAIRES", "Uniquement les dates scolaires")]
    type_date = models.CharField(verbose_name="Type de date", max_length=100, choices=choix_type_date, default="TOUTES")
    choix_affichage = [("TOUJOURS", "Toujours afficher"), ("JAMAIS", "Ne pas afficher"),
                       ("PERIODE", "Afficher sur la période suivante")]
    ...
    modele = models.ForeignKey(ModeleEmail, verbose_name="Modèle d'Email", blank=True, null=True,
                               on_delete=models.PROTECT)
    ...
    prefacturation = models.BooleanField(verbose_name="Activer la préfacturation pour cette période", default=False,
                                         help_text="Cochez cette case pour que la famille puisse payer les prestations de cette période sur le portail même si aucune facture n'a été générée.")
    choix_categories = [("TOUTES", "Toutes les catégories de compte internet"),
                        ("AUCUNE", "Uniquement les catégories de compte internet non renseignées"),
                        ("SELECTION", "Uniquement les catégories suivantes")]
    types_categories = models.CharField(verbose_name="Filtre catégories", max_length=100, choices=choix_categories,
                                        default="TOUTES")
    categories = models.ManyToManyField(CategorieCompteInternet, verbose_name="Sélection de catégories",
                                        related_name="periode_categories", blank=True)
    choix_villes = [("TOUTES", "Toutes les villes de résidence"),
                    ("SELECTION", "Uniquement les familles résidant sur les villes suivantes"),
                    ("SELECTION_INVERSE", "Uniquement les familles ne résidant pas sur les villes suivantes")]
    types_villes = models.CharField(verbose_name="Filtre villes", max_length=100, choices=choix_villes,
                                    default="TOUTES")
    villes = models.CharField(verbose_name="Sélection de villes", max_length=400, blank=True, null=True)
    mode_consultation = models.BooleanField(verbose_name="Mode consultation", default=False,
                                            help_text="Cochez cette case pour que les familles puissent uniquement consulter les réservations de la période sans pouvoir les modifier.")
    ...
    def Is_active_today(self):
        ...
        return self.affichage == "TOUJOURS" or (
                    datetime.datetime.now() >= self.affichage_date_debut and datetime.datetime.now() <= self.affichage_date_fin)
...
class PortailRenseignement(models.Model):
    ...
    traitement_utilisateur = models.ForeignKey(Utilisateur, verbose_name="Traité par", blank=True, null=True,
                                               on_delete=models.PROTECT)
...
class PortailChamp(models.Model):
    ...
    representant = models.CharField(verbose_name="Représentant", max_length=100, choices=choix_etat,
                                    default="MODIFIABLE")
    ...
    def Get_autorisations(self):
        ...
        if self.autorisation_sortie:
            autorisations.append(
                """<span class='badge badge-success' title="Autorisé à récupérer l'individu"><i class='fa fa-sign-out margin-r-5'></i>Sortie</span>""")
        if self.autorisation_appel:
            autorisations.append(
                """<span class='badge badge-success' title="Contacter en cas d'urgence"><i class='fa fa-phone margin-r-5'></i>Urgence</span>""")
...
class Assurance(models.Model):
    ...
    date_fin = models.DateField(verbose_name=_("Date de fin"), blank=True, null=True)
    document = models.FileField(verbose_name=_("Document"), storage=get_storage("assurance"), upload_to=get_uuid_path,
                                blank=True, null=True, help_text="Vous pouvez ajouter un document (PDF ou image).")
...
class Mandat(models.Model):
    ...
    type = models.CharField(verbose_name="Type", max_length=100, choices=choix_type, default="RECURRENT",
                            help_text="Le mandat est généralement de type récurrent.")
    date = models.DateField(verbose_name="Date", help_text="Date de signature du mandat.")
    individu = models.ForeignKey(Individu, verbose_name="Titulaire", on_delete=models.PROTECT, blank=True, null=True,
                                 help_text="Titulaire du compte bancaire. Sélectionnez 'Autre individu' si le titulaire n'est pas dans la liste proposée.")
    ...
    iban = encrypt(models.CharField(verbose_name="IBAN", max_length=27,
                                    help_text="La cohérence de l'IBAN est vérifié lors de l'enregistrement du mandat."))
    bic = encrypt(models.CharField(verbose_name="BIC", max_length=11,
                                   help_text="La cohérence du BIC est vérifié lors de l'enregistrement du mandat."))
    ...
    sequence = models.CharField(verbose_name="Séquence", max_length=100, choices=choix_sequences, default="RCUR",
                                help_text="La prochaine séquence est généralement définie sur RCUR lors de la création du mandat.")
    actif = models.BooleanField(verbose_name="Mandat actif", default=True,
                                help_text="Décochez la case pour désactiver ce mandat.")
    structures = models.ManyToManyField(Structure, verbose_name="Structures associées",
                                        related_name="mandat_structures", blank=True,
                                        help_text="Ce mandat ne sera utilisé que pour les structures sélectionnées.")
...
class PesModele(models.Model):
    ...
    compte = models.ForeignKey(CompteBancaire, verbose_name="Compte à créditer", on_delete=models.PROTECT,
                               help_text="Sélectionnez le compte bancaire à créditer dans le cadre du règlement automatique.")
    ...
    prelevement_libelle = models.CharField(verbose_name="Libellé du prélèvement", max_length=450,
                                           default="{NOM_ORGANISATEUR} - Facture {NUM_FACTURE}",
                                           help_text="Saisissez le libellé du prélèvement qui apparaîtra sur le relevé de compte de la famille. Vous pouvez personnaliser ce libellé grâce aux mots-clés suivants : {NOM_ORGANISATEUR}, {NUM_FACTURE}, {MOIS}, {MOIS_LETTRES}, {ANNEE}, {DATE_DEBUT_MOIS}, {DATE_FIN_MOIS}, {PRESTATION_DATE_MIN}, {PRESTATION_DATE_MAX}, {PRESTATION_DEBUT_MOIS}, {PRESTATION_FIN_MOIS}, {PRESTATION_MOIS}, {PRESTATION_ANNEE}.")
    objet_piece = models.CharField(verbose_name="Libellé de la pièce", max_length=450,
                                   default="Facture {NUM_FACTURE} - {MOIS_LETTRES} {ANNEE}",
                                   help_text="Saisissez l'objet de la pièce par défaut. Vous pouvez personnaliser ce libellé grâce aux mots-clés suivants : {NOM_ORGANISATEUR}, {NUM_FACTURE}, {MOIS}, {MOIS_LETTRES}, {ANNEE}, {DATE_DEBUT_MOIS}, {DATE_FIN_MOIS}, {PRESTATION_DATE_MIN}, {PRESTATION_DATE_MAX}, {PRESTATION_DEBUT_MOIS}, {PRESTATION_FIN_MOIS}, {PRESTATION_MOIS}, {PRESTATION_ANNEE}.")
    prestation_libelle = models.CharField(verbose_name="Libellé de la prestation", max_length=450,
                                          default="{INDIVIDU_PRENOM} - {PRESTATION_LABEL}",
                                          help_text="Saisissez le libellé de la prestation par défaut. Vous pouvez personnaliser ce libellé grâce aux mots-clés suivants : {ACTIVITE_NOM}, {ACTIVITE_ABREGE}, {PRESTATION_LABEL}, {PRESTATION_QUANTITE}, {PRESTATION_MOIS}, {PRESTATION_ANNEE}, {INDIVIDU_NOM}, {INDIVIDU_PRENOM}, {MOIS}, {MOIS_LETTRES}, {ANNEE}, {DATE_DEBUT_MOIS}, {DATE_FIN_MOIS}.")
    nom_collectivite = models.CharField(verbose_name="Nom de la collectivité", max_length=450, blank=True, null=True,
                                        default="{NOM_ORGANISATEUR}",
                                        help_text="Saisissez le nom de la collectivité (Par défaut : {NOM_ORGANISATEUR}).")
    reglement_auto = models.BooleanField(verbose_name="Règlement automatique", default=False,
                                         help_text="Cochez cette case si vous souhaitez que Noethys créé un règlement automatiquement pour les prélèvements.")
    mode = models.ForeignKey(ModeReglement, verbose_name="Mode de règlement", blank=True, null=True,
                             on_delete=models.PROTECT,
                             help_text="Sélectionnez le mode de règlement à utiliser dans le cadre du règlement automatique.")
    payable_internet = models.BooleanField(verbose_name="Titre payable par internet", default=True,
                                           help_text="Cochez cette case si l'usager peut payer sur internet avec PayFip.")
    choix_edition_asap = [
    ...
    edition_asap = models.CharField(verbose_name="Edition ASAP", max_length=100, choices=choix_edition_asap,
                                    default="01", blank=True, null=True,
                                    help_text="Indiquez si l'ASAP doit être édité ou non par le centre éditique (Balise Edition dans bloc pièce du PES Titre).")
    nom_tribunal = models.CharField(verbose_name="Nom du tribunal", max_length=400, blank=True, null=True,
                                    default="le tribunal administratif",
                                    help_text="Saisissez le nom du tribunal administratif de recours.")
    inclure_detail = models.BooleanField(verbose_name="Inclure le détail des factures", default=True,
                                         help_text="Cochez cette case si vous souhaitez que Noethys intègre le détail des prestations de chaque facture.")
    inclure_pieces_jointes = models.BooleanField(verbose_name="Inclure les factures au format PDF", default=True,
                                                 help_text="Cochez cette case si vous souhaitez que Noethys intègre les factures au format PDF.")
    code_compta_as_alias = models.BooleanField(verbose_name="Utiliser le code comptable familial comme code tiers",
                                               default=True,
                                               help_text="Utiliser le code comptable de la famille (Fiche famille > Onglet Divers) comme code tiers (ou alias). Sinon un code de type FAM000001 sera généré automatiquement.")
    modele_document = models.ForeignKey(ModeleDocument, verbose_name="Modèle de document", on_delete=models.PROTECT,
                                        blank=True, null=True)
    inclure_tiers_solidaires = models.BooleanField(verbose_name="Inclure les tiers solidaires", default=True,
                                                   help_text="Cochez cette case si vous souhaitez que Noethys intègre les tiers solidaires.")
...
class PesLot(models.Model):
    ...
    nom = models.CharField(verbose_name="Nom de l'export", max_length=200,
                           help_text="Nom interne à l'application. Exemple : Restauration - Janvier 2021.")
    # verrouillage = models.BooleanField(verbose_name="Verrouillage", default=False)
    observations = models.TextField(verbose_name="Observations", blank=True, null=True)
...
class PesPiece(models.Model):
    ...
    prelevement_mandat = models.ForeignKey(Mandat, verbose_name="Mandat", blank=True, null=True,
                                           on_delete=models.PROTECT)
    prelevement_sequence = models.CharField(verbose_name="Séquence", blank=True, null=True,
                                            choices=[("OOFF", "Prélèvement ponctuel (OOFF)"),
                                                     ("FRST", "Premier prélèvement d'une série (FRST)"),
                                                     ("RCUR", "Prélèvement suivant d'une série (RCUR)"),
                                                     ('FNAL', "Dernier prélèvement d'une série (FNAL)")],
                                            max_length=100)
    prelevement_statut = models.CharField(verbose_name="Statut du prélèvement",
                                          choices=[("valide", "Valide"), ("refus", "Refus"), ("attente", "Attente")],
                                          default="attente", max_length=100)
    prelevement_reglement = models.ForeignKey(Reglement, verbose_name="Règlement", on_delete=models.SET_NULL,
                                              blank=True, null=True)
    titulaire_helios = models.ForeignKey(Individu, verbose_name="Titulaire Hélios",
                                         related_name="piece_titulaire_helios", on_delete=models.PROTECT)
    tiers_solidaire = models.ForeignKey(Individu, verbose_name="Tiers solidaire", related_name="piece_tiers_solidaire",
                                        on_delete=models.PROTECT, blank=True, null=True)
    type = models.CharField(verbose_name="Type de pièce", choices=[("facture", "Facture"), ("manuel", "Manuel")],
                            max_length=100, default="facture")
...
class Consentement(models.Model):
    ...
    famille = models.ForeignKey(Famille, verbose_name="Famille", on_delete=models.PROTECT, blank=True, null=True)
    individu = models.ForeignKey(Individu, verbose_name="Individu", on_delete=models.PROTECT, blank=True, null=True)
    unite_consentement = models.ForeignKey(UniteConsentement, verbose_name="Unité de consentement",
                                           on_delete=models.PROTECT)
...
class Album(models.Model):
    ...
    titre = models.CharField(verbose_name="Titre de l'album", max_length=300,
                             help_text="Le titre est visible pour les familles sur le portail.")
    description = models.TextField(verbose_name="Description", blank=True, null=True,
                                   help_text="La description est visible pour les familles sur le portail.")
    auteur = models.ForeignKey(Utilisateur, verbose_name="Auteur", blank=True, null=True, on_delete=models.CASCADE)
    date_creation = models.DateTimeField(verbose_name="Date de création", auto_now_add=True)
...
class Photo(models.Model):
    ...
    titre = models.CharField(verbose_name="Titre de la photo", max_length=300, blank=True, null=True,
                             help_text="Le titre est visible pour les familles sur le portail.")
    date_creation = models.DateTimeField(verbose_name="Date de création", blank=True, null=True,
                                         help_text="Cette date est utilisée pour trier les photos.")
...
class Article(models.Model):
    ...
    texte = models.TextField(verbose_name="Texte")
    image = models.ImageField(verbose_name="Image", upload_to=get_uuid_path, blank=True, null=True)
    image_article = models.ForeignKey(ImageArticle, verbose_name="Image", blank=True, null=True,
                                      on_delete=models.SET_NULL)
    auteur = models.ForeignKey(Utilisateur, verbose_name="Auteur", blank=True, null=True, on_delete=models.CASCADE)
    date_debut = models.DateTimeField(verbose_name="Début de publication",
                                      help_text="Saisissez la date de début de publication. Par défaut, la date du jour de la création de l'article.")
    date_fin = models.DateTimeField(verbose_name="Fin de publication", blank=True, null=True,
                                    help_text="Laissez vide pour ne pas définir de date de fin de publication.")
    choix_couleur = [(None, "Par défaut"), ("primary", "Bleu foncé"), ("info", "Bleu clair"), ("success", "Vert"),
                     ("warning", "Jaune"), ("danger", "Rouge"), ("gray", "Gris")]
    couleur_fond = models.CharField(verbose_name="Couleur de fond", max_length=100, choices=choix_couleur, default=None,
                                    blank=True, null=True,
                                    help_text="Couleur de fond du cadre de l'article. Blanc par défaut.")
    choix_statut = [("publie", "Publié"), ("non_publie", "Non publié")]
    statut = models.CharField(verbose_name="Statut", max_length=100, choices=choix_statut, default="publie",
                              help_text="Sélectionnez Non publié pour interrompre la publication quelque soit la date de fin de publication prévue.")
    document = models.FileField(verbose_name="Document", upload_to=get_uuid_path, blank=True, null=True,
                                help_text="Privilégiez un document au format PDF.")
    document_titre = models.CharField(verbose_name="Titre", max_length=300, default="Document",
                                      help_text="Saisissez un nom de document.")
    structure = models.ForeignKey(Structure, verbose_name="Structure", on_delete=models.PROTECT, blank=True, null=True)
    choix_public = [("toutes", "Toutes les familles"),
                    ("inscrits", "Les familles dont un membre est inscrit à l'une des activités suivantes"),
                    ("presents",
                     "Les familles dont un membre est présent sur l'une des activités suivantes et sur la période suivante"),
                    ("presents_groupes",
                     "Les familles dont un membre est présent sur l'un des groupes suivants et sur la période suivante"),
                    ]
    public = models.CharField(verbose_name="Public", max_length=100, choices=choix_public,
    ...
    activites = models.ManyToManyField(Activite, verbose_name="Activités", related_name="article_activites", blank=True,
                                       help_text="Sélectionnez une ou plusieurs activités dans la liste.")
    groupes = models.ManyToManyField(Groupe, verbose_name="Groupes", related_name="article_groupes", blank=True,
                                     help_text="Sélectionnez un ou plusieurs groupes dans la liste.")
    ...
    album = models.ForeignKey(Album, verbose_name="Album photos", blank=True, null=True, on_delete=models.SET_NULL,
                              help_text="Sélectionnez un album photos existant à joindre à cet article.")
    texte_popup = models.TextField(verbose_name="Texte", blank=True, null=True,
                                   help_text="Ce texte sera affiché dans une fenêtre popup sur la page d'accueil. A utiliser uniquement pour les informations importantes.")
    sondage = models.ForeignKey("Sondage", verbose_name="Formulaire", blank=True, null=True, on_delete=models.SET_NULL,
                                help_text="Sélectionnez un formulaire existant à joindre à cet article.")
...
class PortailDocument(models.Model):
    ...
    titre = models.CharField(verbose_name="Titre", max_length=200,
                             help_text="Saisissez un titre pour ce document. Ex : Fiche d'inscription annuelle...")
    texte = models.CharField(verbose_name="Sous-titre", max_length=200, blank=True, null=True,
                             help_text="Vous pouvez saisir un sous-titre. Ex : Version 2021...")
    choix_couleur = [("primary", "Bleu foncé"), ("info", "Bleu clair"), ("success", "Vert"), ("warning", "Jaune"),
                     ("danger", "Rouge"), ("gray", "Gris")]
    couleur_fond = models.CharField(verbose_name="Couleur de fond", max_length=100, choices=choix_couleur,
                                    default="primary", help_text="Couleur de fond de l'icône. Bleu foncé par défaut.")
    document = models.FileField(verbose_name="Document", upload_to=get_uuid_path,
                                help_text="Privilégiez un document au format PDF.")
    structure = models.ForeignKey(Structure, verbose_name="Structure", on_delete=models.PROTECT, blank=True, null=True)
    type_piece = models.ForeignKey(TypePiece, verbose_name="Type de pièce", related_name="type_piece_document",
                                   on_delete=models.PROTECT, blank=True, null=True,
                                   help_text="Si ce document correspond à un type de pièce existant, sélectionnez-le dans la liste proposée.")
...
class SMS(models.Model):
    ...
    utilisateur = models.ForeignKey(Utilisateur, verbose_name="Utilisateur", blank=True, null=True,
                                    on_delete=models.CASCADE)
    configuration_sms = models.ForeignKey(ConfigurationSMS, verbose_name="Configuration", blank=True, null=True,
                                          on_delete=models.SET_NULL)
    ...
    def __str__(self):
        return "SMS du %s : %s" % (self.date_creation.strftime('%d/%m/%Y %H:%m') if self.date_creation else "X",
                                   self.objet if self.objet else "Sans objet")
...
class PrelevementsModele(models.Model):
    ...
    compte = models.ForeignKey(CompteBancaire, verbose_name="Compte à créditer", on_delete=models.PROTECT,
                               help_text="Sélectionnez le compte bancaire à créditer.")
    mode = models.ForeignKey(ModeReglement, verbose_name="Mode de règlement", blank=True, null=True,
                             on_delete=models.PROTECT, help_text="Sélectionnez le mode de règlement à utiliser.")
    reglement_auto = models.BooleanField(verbose_name="Règlement automatique", default=False,
                                         help_text="Cochez cette case si vous souhaitez que Noethysweb créé un règlement automatiquement.")
    encodage = models.CharField(verbose_name="Encodage", max_length=100,
                                choices=[("utf-8", "UTF-8"), ("iso-8859-15", "ISO-8859-15")], default="utf-8",
                                help_text="Sélectionnez le format souhaité")
    perception = models.ForeignKey(Perception, verbose_name="Perception", on_delete=models.PROTECT, blank=True,
                                   null=True)
    identifiant_service = models.CharField(verbose_name="Identifiant du service", max_length=200, blank=True, null=True,
                                           help_text="Saisissez l'identifiant du service. Exemple : TGDFT027 (numéro de département sur 3 chiffres).")
    poste_comptable = models.CharField(verbose_name="Poste comptable par défaut", max_length=200, blank=True, null=True,
                                       help_text="Saisissez le codique de la DDFiP de rattachement sur 6 caractères. Exemple : 027000")
...
class PrelevementsLot(models.Model):
    ...
    # verrouillage = models.BooleanField(verbose_name="Verrouillage", default=False)
    observations = models.TextField(verbose_name="Observations", blank=True, null=True)
    motif = models.CharField(verbose_name="Motif", max_length=300, blank=True, null=True,
                             help_text="Saisissez le motif du prélèvement. Ex : 'Garderie Novembre 2019'.")
    numero_sequence = models.IntegerField(verbose_name="Numéro de séquence", default=1, blank=True, null=True,
                                          help_text="Numéro de séquence du fichier dans une même journée. Exemple: 1 = premier fichier de la journée.")
...
class Prelevements(models.Model):
    ...
    famille = models.ForeignKey(Famille, verbose_name="Famille", on_delete=models.PROTECT)
    type = models.CharField(verbose_name="Type", choices=[("facture", "Facture"), ("manuel", "Manuel")], max_length=100,
                            default="facture")
    facture = models.ForeignKey(Facture, verbose_name="Facture", on_delete=models.PROTECT, blank=True, null=True)
    montant = models.DecimalField(verbose_name="Montant", max_digits=10, decimal_places=2)
    mandat = models.ForeignKey(Mandat, verbose_name="Mandat", on_delete=models.PROTECT)
    sequence = models.CharField(verbose_name="Séquence", choices=[("OOFF", "Prélèvement ponctuel (OOFF)"),
                                                                  ("FRST", "Premier prélèvement d'une série (FRST)"),
                                                                  ("RCUR", "Prélèvement suivant d'une série (RCUR)"),
                                                                  ('FNAL', "Dernier prélèvement d'une série (FNAL)")],
                                max_length=100)
...
class Paiement(models.Model):
    ...
    notification = models.DateTimeField(verbose_name="Horodatage de la notification à l'utilisateur", blank=True,
                                        null=True)
...
class Tache(models.Model):
    ...
    tache_recurrente = models.ForeignKey(Tache_recurrente, verbose_name="Tâche récurrente", blank=True, null=True,
                                         on_delete=models.CASCADE)
    date = models.DateField(verbose_name="Date")
    titre = models.CharField(verbose_name="Titre", max_length=250)
    utilisateur = models.ForeignKey(Utilisateur, verbose_name="Utilisateur", blank=True, null=True,
...
class AttestationFiscale(models.Model):
    ...
    date_debut = models.DateField(verbose_name="Date de début")
    date_fin = models.DateField(verbose_name="Date de fin")
    lot = models.ForeignKey(LotAttestationsFiscales, verbose_name="Lot d'attestations fiscales",
                            on_delete=models.PROTECT, blank=True, null=True)
    total = models.DecimalField(verbose_name="Total", max_digits=10, decimal_places=2, default=0.0)
...
class ComptaCategorie(models.Model):
    ...
    compte_comptable = models.ForeignKey(ComptaCompteComptable, verbose_name="Compte comptable",
                                         on_delete=models.PROTECT, blank=True, null=True)
    structure = models.ForeignKey(Structure, verbose_name="Structure", on_delete=models.PROTECT, blank=True, null=True)
...
class ComptaVirement(models.Model):
    ...
    montant = models.DecimalField(verbose_name="Montant", max_digits=10, decimal_places=2, default=0.0)
    observations = models.TextField(verbose_name="Observations", blank=True, null=True)
    compte_debit = models.ForeignKey(CompteBancaire, verbose_name="Compte débiteur",
                                     related_name="virement_compte_debit", on_delete=models.CASCADE)
    compte_credit = models.ForeignKey(CompteBancaire, verbose_name="Compte créditeur",
                                      related_name="virement_compte_credit", on_delete=models.CASCADE)
    releve_debit = models.ForeignKey(ComptaReleve, verbose_name="Relevé débiteur", related_name="virement_releve_debit",
                                     on_delete=models.CASCADE, blank=True, null=True)
    releve_credit = models.ForeignKey(ComptaReleve, verbose_name="Relevé créditeur",
                                      related_name="virement_releve_credit", on_delete=models.CASCADE, blank=True,
                                      null=True)
    operation_debit = models.ForeignKey("ComptaOperation", verbose_name="Opération au débit",
                                        related_name="virement_operation_debit", on_delete=models.CASCADE, blank=True,
                                        null=True)
    operation_credit = models.ForeignKey("ComptaOperation", verbose_name="Opération au crédit",
                                         related_name="virement_operation_credit", on_delete=models.CASCADE, blank=True,
                                         null=True)
...
class ComptaOperation(models.Model):
    ...
    mode = models.ForeignKey(ModeReglement, verbose_name="Mode de règlement", on_delete=models.PROTECT, blank=True,
                             null=True)
    ...
    compte = models.ForeignKey(CompteBancaire, verbose_name="Compte bancaire", on_delete=models.PROTECT)
    releve = models.ForeignKey(ComptaReleve, verbose_name="Relevé bancaire", on_delete=models.PROTECT, blank=True,
                               null=True)
    montant = models.DecimalField(verbose_name="Montant", max_digits=10, decimal_places=2, default=0.0)
    observations = models.TextField(verbose_name="Observations", blank=True, null=True)
    virement = models.ForeignKey(ComptaVirement, verbose_name="Virement", on_delete=models.CASCADE, blank=True,
                                 null=True)
    document = models.FileField(verbose_name="Document", upload_to=get_uuid_path, blank=True, null=True)
...
class ComptaOperationBudgetaire(models.Model):
    ...
    type = models.CharField(verbose_name="Type", max_length=50, choices=[("debit", "Débit"), ("credit", "Crédit")])
    date_budget = models.DateField(verbose_name="Date budget")
    compte = models.ForeignKey(CompteBancaire, verbose_name="Compte bancaire", on_delete=models.PROTECT, blank=True,
                               null=True)
    categorie = models.ForeignKey(ComptaCategorie, verbose_name="Catégorie", on_delete=models.PROTECT)
    analytique = models.ForeignKey(ComptaAnalytique, verbose_name="Analytique", on_delete=models.PROTECT)
    libelle = models.CharField(verbose_name="Libellé", max_length=200, blank=True, null=True)
...
class ComptaBudget(models.Model):
    ...
    date_debut = models.DateField(verbose_name="Date de début")
    date_fin = models.DateField(verbose_name="Date de fin")
    analytiques = models.ManyToManyField(ComptaAnalytique, verbose_name="Poste analytiques",
                                         related_name="postes_analytiques")
    structure = models.ForeignKey(Structure, verbose_name="Structure", on_delete=models.PROTECT, blank=True, null=True)
...
class TypePieceCollaborateur(models.Model):
    ...
    nom = models.CharField(verbose_name="Nom", max_length=200)
    duree_validite = models.CharField(verbose_name="Durée de validité", max_length=100, blank=True, null=True)
    obligatoire = models.CharField(verbose_name="Obligatoire", max_length=50, choices=[("OUI", "Oui"), ("NON", "Non"), (
    "QUALIFICATIONS", "Obligatoire pour les qualifications suivantes"), ("POSTES",
                                                                         "Obligatoire pour les postes suivants")],
                                   default="NON")
    qualifications = models.ManyToManyField(TypeQualificationCollaborateur, verbose_name="Qualifications associées",
                                            related_name="type_piece_qualifications", blank=True)
    postes = models.ManyToManyField(TypePosteCollaborateur, verbose_name="Postes associés",
                                    related_name="type_piece_postes", blank=True)
    structure = models.ForeignKey(Structure, verbose_name="Structure", on_delete=models.PROTECT, blank=True, null=True)
...
class GroupeCollaborateurs(models.Model):
    idgroupe = models.AutoField(verbose_name="ID", db_column='IDgroupe', primary_key=True)
    nom = models.CharField(verbose_name="Nom", max_length=200)
    superviseurs = models.ManyToManyField(Utilisateur, verbose_name="Superviseurs",
                                          related_name="superviseurs_groupe_collaborateurs")
...
class Collaborateur(models.Model):
    ...
    civilite = models.CharField(verbose_name="Civilité", max_length=50, choices=[("M", "Monsieur"), ("MME", "Madame")],
                                default="M")
    nom = models.CharField(verbose_name="Nom", max_length=200)
    ...
    qualifications = models.ManyToManyField(TypeQualificationCollaborateur, verbose_name="Qualifications",
                                            related_name="collaborateur_qualifications", blank=True)
    groupes = models.ManyToManyField(GroupeCollaborateurs, verbose_name="Groupes associés",
                                     related_name="collaborateur_groupes", blank=True)
...
class PieceCollaborateur(models.Model):
    idpiece = models.AutoField(verbose_name="ID", db_column='IDpiece', primary_key=True)
    type_piece = models.ForeignKey(TypePieceCollaborateur, verbose_name="Type de pièce", on_delete=models.PROTECT,
                                   blank=True, null=True)
    collaborateur = models.ForeignKey(Collaborateur, verbose_name="Collaborateur", on_delete=models.CASCADE, blank=True,
                                      null=True)
    date_debut = models.DateField(verbose_name="Date de début", blank=True, null=True)
    date_fin = models.DateField(verbose_name="Date de fin", blank=True, null=True)
    document = models.FileField(verbose_name="Document", storage=get_storage("piece_collaborateur"),
                                upload_to=get_uuid_path, blank=True, null=True)
    titre = models.CharField(verbose_name="Titre", max_length=200, blank=True, null=True)
    observations = models.TextField(verbose_name="Observations", blank=True, null=True)
...
class TypeEvenementCollaborateur(models.Model):
    ...
    type = models.CharField(verbose_name="Type", max_length=100,
                            choices=[("ADDITION", "Temps comptabilisé"), ("NEUTRE", "Temps non comptabilisé"),
                                     ("SOUSTRACTION", "Temps soustrait")])
...
class EvenementCollaborateur(models.Model):
    idevenement = models.AutoField(verbose_name="ID", db_column="IDevenement", primary_key=True)
    collaborateur = models.ForeignKey(Collaborateur, verbose_name="Collaborateur", on_delete=models.PROTECT, blank=True,
                                      null=True)
    type_evenement = models.ForeignKey(TypeEvenementCollaborateur, verbose_name="Catégorie", on_delete=models.PROTECT,
                                       blank=True, null=True)
    date_debut = models.DateTimeField(verbose_name="Début", blank=True, null=True)
    date_fin = models.DateTimeField(verbose_name="Fin", blank=True, null=True)
    titre = models.CharField(verbose_name="Titre", max_length=200, blank=True, null=True)
...
class LigneModelePlanningCollaborateur(models.Model):
    ...
    periode = models.CharField(verbose_name="Période", max_length=50,
                               choices=[("TOUTES", "Toutes les périodes"), ("SCOLAIRES", "Période scolaire"),
                                        ("VACANCES", "Période de vacances")], default="TOUTES")
...
class Transport(models.Model):
    ...
    categorie = models.CharField(verbose_name="Catégorie", max_length=200, choices=CATEGORIES_TRANSPORTS)
    compagnie = models.ForeignKey(TransportCompagnie, verbose_name="Compagnie", blank=True, null=True,
                                  on_delete=models.PROTECT)
    ...
    depart_arret = models.ForeignKey(TransportArret, verbose_name="Arrêt", related_name="transport_depart_arret",
                                     blank=True, null=True, on_delete=models.PROTECT)
    depart_lieu = models.ForeignKey(TransportLieu, verbose_name="Lieu", related_name="transport_depart_lieu",
                                    blank=True, null=True, on_delete=models.PROTECT)
    ...
    arrivee_arret = models.ForeignKey(TransportArret, verbose_name="Arrêt", related_name="transport_arrivee_arret",
                                      blank=True, null=True, on_delete=models.PROTECT)
    arrivee_lieu = models.ForeignKey(TransportLieu, verbose_name="Lieu", related_name="transport_arrivee_lieu",
                                     blank=True, null=True, on_delete=models.PROTECT)
    ...
    actif = models.BooleanField(verbose_name="Actif", default=True)
    jours_scolaires = MultiSelectField(verbose_name="Jours scolaires", max_length=100, choices=JOURS_SEMAINE,
                                       blank=True, null=True)
    jours_vacances = MultiSelectField(verbose_name="Jours de vacances", max_length=100, choices=JOURS_SEMAINE,
                                      blank=True, null=True)
...
class Sondage(models.Model):
    ...
    titre = models.CharField(verbose_name="Titre", max_length=300)
    description = models.TextField(verbose_name="Description", blank=True, null=True,
                                   help_text="Ce texte sera affiché comme introduction du formulaire de saisie.")
    conclusion = models.TextField(verbose_name="Texte après validation", blank=True, null=True,
                                  help_text="Ce texte sera affiché après la validation de la réponse par la famille.")
    code = models.CharField(verbose_name="Code du formulaire", max_length=300, default=get_uuid)
    public = models.CharField(verbose_name="Public", max_length=50,
                              choices=[("individu", "Individu"), ("famille", "Famille")], default="famille",
                              help_text="Indiquez si la réponse devra être unique pour la famille ou spécifique à un individu.")
    categories_rattachements = MultiSelectField(verbose_name="Catégories de rattachement", max_length=200,
                                                choices=CATEGORIES_RATTACHEMENT, blank=True, null=True,
                                                help_text="Sélectionnez les catégories d'individus qui pourront être associés à ce formulaire.")
    modifiable = models.BooleanField(verbose_name="Réponses modifiables", default=True,
                                     help_text="Cochez cette case si vous souhaitez que les familles puissent modifier leurs réponses.")
    structure = models.ForeignKey(Structure, verbose_name="Structure", on_delete=models.PROTECT, blank=True, null=True)
...
class SondagePage(models.Model):
    ...
    titre = models.CharField(verbose_name="Titre", max_length=300,
                             help_text="Ce titre sera affiché uniquement si le formulaire comporte plusieurs pages.")
    description = models.TextField(verbose_name="Description", blank=True, null=True,
                                   help_text="Ce texte sera affiché sous le titre de la page.")
    ordre = models.IntegerField(verbose_name="Ordre")
...
class SondageQuestion(models.Model):
    ...
    texte_aide = models.CharField(verbose_name="Texte d'aide", max_length=500, blank=True, null=True,
                                  help_text="Vous pouvez saisir un texte d'aide qui apparaîtra sous le champ de saisie.")
    obligatoire = models.BooleanField(verbose_name="Obligatoire", default=False,
                                      help_text="Cochez cette case si la famille doit obligatoirement répondre à cette question.")
...
class SondageReponse(models.Model):
    idreponse = models.AutoField(verbose_name="ID", db_column='IDreponse', primary_key=True)
    repondant = models.ForeignKey(SondageRepondant, verbose_name="Répondant", blank=True, null=True,
                                  on_delete=models.CASCADE)
...
class AchatDemande(models.Model):
    ...
    def Maj_etat(self):
        stats = AchatArticle.objects.filter(demande=self).aggregate(nbre=Count("idarticle"),
                                                                    nbre_achetes=Count("idarticle",
                                                                                       filter=Q(achete=True)))
...
class AchatArticle(models.Model):
    ...
    fournisseur = models.ForeignKey(AchatFournisseur, verbose_name="Fournisseur", on_delete=models.PROTECT, blank=True,
                                    null=True)
    categorie = models.ForeignKey(AchatCategorie, verbose_name="Catégorie", on_delete=models.PROTECT, blank=True,
                                  null=True)
    libelle = models.CharField(verbose_name="Libellé", max_length=300, blank=True, null=True)
...
class CommandeModele(models.Model):
    idmodele = models.AutoField(verbose_name="ID", db_column="IDmodele", primary_key=True)
    nom = models.CharField(verbose_name="Nom", max_length=200)
    restaurateur = models.ForeignKey(Restaurateur, verbose_name="Restaurateur", on_delete=models.PROTECT, blank=True,
                                     null=True)
    defaut = models.BooleanField(verbose_name="Modèle par défaut", default=False)
    structure = models.ForeignKey(Structure, verbose_name="Structure", on_delete=models.PROTECT, blank=True, null=True)
