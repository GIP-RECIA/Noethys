...
LISTE_PARAMETRES = [
    ...
    Parametre(code="reservations_ventilation_auto", label="Effectuer une ventilation automatique si besoin après la modification du planning", type="boolean", valeur=False, help_text="Après la modification du planning, une ventilation automatique est effectuée si besoin afin de ventiler d'éventuels avoirs."),
